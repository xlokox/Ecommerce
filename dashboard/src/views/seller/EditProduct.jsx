...
const EditProduct = () => {
  ...
  // 2. טעינת מוצר לפי productId
  useEffect(() => {
    dispatch(get_product(productId));
  }, [productId, dispatch]);

  // 3. state פנימי של הטופס
  ...
  const changeImage = (oldImg, files) => {
    if (files.length > 0) {
  ...
  // 8. ברגע שהקטגוריות נטענו, שומרים אותן ב-allCategory
  useEffect(() => {

...
const AddBanner = () => {
  ...
  const update = (e) => {
    ...
    if (banner && banner._id) {
      ...
      toast.error("Banner not found for update");
    }
  };

  // קריאה ל-get_banner עם productId
  useEffect(() => {
    if (productId) {
        ...
        {!banner ? (
          <div>
            <form onSubmit={add}>
              ...
              {imageShow && (
                <div className='mb-4'>
                  <img className='w-full h-[300px]' src={imageShow} alt="Banner Preview" />
                </div>
              )}
          ...
          <div>
            ...
            <form onSubmit={update}>
              ...
              {imageShow && (
                <div className='mb-4'>
                  <img className='w-full h-[300px]' src={imageShow} alt="Updated Banner Preview" />
                </div>
              )}
              <button disabled={loader} className='bg-red-500 w-[280px] hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>

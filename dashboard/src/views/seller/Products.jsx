              ...
              {products.map((d, i) => (
                <tr key={i}>
                  ...
                  <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    {/* שימוש ב-d.images[0] במקום products.images[0] */}
                  ...
                  <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    <div className='flex justify-start items-center gap-4'>
                      ...
                      <Link to={`/seller/dashboard/add-banner/${d._id}`} className='p-[6px] bg-sky-500 rounded hover:shadow-lg hover:shadow-yellow-500/50'>
                        <LuImageMinus />
                      </Link>
